...
public class Branch {
    ...
    public boolean newCustomer(String name, double initialTransaction) {
        Customer customerValue = findCustomer(name);
    ...
    public boolean addCustomerTransaction(String nameCustomer, double transactions) {
        Customer existingCustomer = findCustomer(nameCustomer);
        if (existingCustomer != null) {
            existingCustomer.addTransaction(transactions);
            return true;
        } else {
            return false;
        }
