...
public class Point {
   ...
   public void setY(int y)
   {
    ...
    public double distance()
    {
        ...
        int x2=this.x;
        int y2=this.y;
        double value= (double)((x2-x1)*(x2-x1)+(y2-y1)*(y2-y1));
    ...
    public static void main(String[] args) {
        Point first=new Point(6,5);
        Point second=new Point(3,1);
        System.out.println("distanc(0,0) "+first.distance());
        System.out.println("distanc(second)"+first.distance(second));
        System.out.println("distanc(2,2)"+first.distance(2,2));
        Point point=new Point();
        System.out.println("distanc()"+point.distance());   
