...
public class FlourPackProblem {
    ...
    public static boolean canPack(int bigCount, int smallCount, int goal) {
        if (bigCount >= 0 && smallCount >= 0 && goal >= 0) {
            ...
            if(bigvalue>goal && smallCount!=0)
            {
                int value=goal-(bigvalue-5);
                if(value<=smallCount)
                {
                    return true;
                }
            ...
            if((goal>bigvalue)&&(smallCount!=0)&&(bigCount!=0)){
                int value=goal-bigvalue;
                if((value<=smallCount) && (goal==bigvalue+value))
                {
                    return true;
                }
                else{
